...
if __name__ == "__main__":
    #c = MongoReplicaSetClient('127.0.0.1:27001', replicaSet='rs',port=27001,read_preference=ReadPreference.SECONDARY)
    #connect('torrentinfo-db',host='127.0.0.1:27001',port=27001,replicaSet='rs')
